...
describe("3 名玩家在經典模式的開局", () => {
  ...
  describe("假設玩家O放D4，玩家X放E4", () => {
    beforeEach(() => {
      game.placePieceOnTurn("O", "D4");
      game.placePieceOnTurn("X", "E4");
    });

    test("當玩家D下子在E5時，E5應該要有棋子D，並且輪到玩家O，而且玩家都放過棋子了", () => {
      game.placePieceOnTurn("D", "E5");
